                                ...
                                <div class="subject">
                                    <div class="player">
                                        <div class="player-level">
                                            <div class="level-background" id="level-bg-{{ getLevelBackgroundName(\App\Enums\ExpActions::getUserLevel($requestMaker)) }}">
                                                <div class="aux-1"></div>
                                                <div class="aux-2"></div>
                                                <div class="aux-3"></div>
                                                <div class="aux-4"></div>
                                                ...
                                                @if (getLevelBackgroundName(\App\Enums\ExpActions::getUserLevel($requestMaker)) == 'anonymous')
                                            ...
                                            <span class="player-level-value">{{ \App\Enums\ExpActions::getUserLevel($requestMaker) }}</span>
                                        </div>
