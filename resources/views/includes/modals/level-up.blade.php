        ...
        <section id="modal-top">
            ...
            ">
                ...
                <div class="player-level">
                    <div class="level-background" id="level-bg-{{ getLevelBackgroundName(\App\Enums\ExpActions::getUserLevel(Auth::user())) }}">
                        <div class="aux-1"></div>
                        <div class="aux-2"></div>
                        <div class="aux-3"></div>
                        <div class="aux-4"></div>
                        ...
                        @if (getLevelBackgroundName(\App\Enums\ExpActions::getUserLevel(Auth::user())) == 'anonymous')
                    ...
                    <span class="player-level-value level_value">{{ \App\Enums\ExpActions::getUserLevel(Auth::user()) }}</span>
                </div>
            </div>
        </section>
