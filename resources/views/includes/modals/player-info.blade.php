...
<div style="z-index: 3;" id="player-info-modal" class="modal" closable="true">
    <section class="modal-frame">
        ...
        <div class="player-level">
            <div class="level-background" id="level-bg-{{ getLevelBackgroundName(\App\Enums\ExpActions::getUserLevel($user)) }}">
                ...
                <div style="{{ getLevelBackgroundName(\App\Enums\ExpActions::getUserLevel($user)) == 'anonymous' ? 'display: block;' : 'display: none;'}}" class="anonymous-mask">
    ...
    @include('includes.back-btn', ['callback' => 'closePlayerInfoModal()'])
</div>
